...
import (
	...
	"github.com/panghalamit/go-ethereum/swarm/shed"
...
//
// # go test -benchmem -run=none github.com/panghalamit/go-ethereum/swarm/storage/localstore -bench BenchmarkNew -v -timeout 20m
// goos: darwin
// goarch: amd64
